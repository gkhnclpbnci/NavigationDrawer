...
import example.batuhan.www.navigationdrawer.XpandableListAdapter;
...
public class Ekibimiz1Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void initNavigationDrawer() {
        ...
        expandableList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            /*    Toast.makeText(Ekibimiz1Activity.this,
