...
import pages.Ekibimiz1Fragment;
import pages.Ekibimiz2Fragment;
import pages.Ekibimiz3Fragment;
import pages.Ekibimiz4Fragment;
import pages.Ekibimiz5Fragment;
import pages.Ekibimiz6Fragment;
...
public class EkibimizBaseActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ekibimiz1);
    ...
    private void initNavigationDrawer() {
        ...
        expandableList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView,
                ...
                Toast.makeText(EkibimizBaseActivity.this,
    ...
    private void displayPage(int position) {
        ...
        switch (position) {
            ...
            case 9:
                ...
                break;
            case 10:
                fragment = new Ekibimiz1Fragment();
                fragment_name = "Ekibimiz1Fragment";
                mDrawerLayout.closeDrawers();

                break;
            case 11:
                fragment = new Ekibimiz2Fragment();
                fragment_name = "Ekibimiz2Fragment";
                mDrawerLayout.closeDrawers();

                break;
            case 12:
                fragment = new Ekibimiz3Fragment();
                fragment_name = "Ekibimiz3Fragment";
                mDrawerLayout.closeDrawers();

                break;
            case 13:
                fragment = new Ekibimiz4Fragment();
                fragment_name = "Ekibimiz4Fragment";
                mDrawerLayout.closeDrawers();

                break;
            case 14:
                fragment = new Ekibimiz5Fragment();
                fragment_name = "Ekibimiz5Fragment";
                mDrawerLayout.closeDrawers();

                break;
            case 15:
                fragment = new Ekibimiz6Fragment();
                fragment_name = "Ekibimiz6Fragment";
                mDrawerLayout.closeDrawers();
